...
controller.hears(['Articuno','Lugia','Moltres','Zapdos','Mewtwo','Raikou','Suicune ','Entei','Ho-Oh',"Groudon","Kyogre"], 'ambient', (bot, message) => {
	var whodisid2 = 'empty'
	var whodis2 = 'empty'
	var whochannel2 = 'empty'
		...
		if (whochannel4 == "raid-battles-botalert"  && whodis4 == "ooglybot"){
			...
			var req4 = http.request(options4, function (res) {
				...
				res.on("end", function () {
					...
					if (coords4 == "30.00526,-90.17554" || coords4 == "30.00415,-90.10547" || coords4 == "29.953703,-90.069243" || coords4 == "29.94976,-90.06984" || coords4 == "29.89542,-90.06016" || coords4 == "29.96421,-90.18622") {
						bot.say({
						text: callout4,
		 ...
		 if (whochannel4 == "raid-battles-wbalert"  && whodis4 == "ooglybot"){
			...
			var req4 = http.request(options4, function (res) {
				...
				res.on("end", function () {
					...
					if (coords4 == "30.00526,-90.17554" || coords4 == "30.00415,-90.10547" || coords4 == "29.95370,-90.06924" || coords4 == "29.94976,-90.06984" || coords4 == "29.89542,-90.06016" || coords4 == "29.96421,-90.18622") {
						bot.say({
						text: callout4,
						channel: "raid-battles-spons"
						});						
